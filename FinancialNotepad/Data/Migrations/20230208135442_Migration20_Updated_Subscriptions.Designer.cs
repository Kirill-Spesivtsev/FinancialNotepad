...
namespace FinancialNotepad.Data.Migrations
{
    ...
    [Migration("20230208135442_Migration20_Updated_Subscriptions")]
    partial class Migration20_Updated_Subscriptions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinancialNotepad.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("FinancialNotepad.Models.Subscription", b =>
                {
            ...
            modelBuilder.Entity("FinancialNotepad.Models.Transaction", b =>
                {
            ...
            modelBuilder.Entity("FinancialNotepad.Models.Transaction", b =>
                {
                    b.HasOne("FinancialNotepad.Models.Category", "Category")
                        .WithMany("Transactions")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FinancialNotepad.Models.Currency", "Currency")
                        .WithMany()
                        .HasForeignKey("CurrencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FinancialNotepad.Models.Tax", "Tax")
                        .WithMany()
                        .HasForeignKey("TaxId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
